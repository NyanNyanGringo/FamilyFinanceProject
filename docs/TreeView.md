...
**Последнее обновление:** 2025-06-17 18:42:05
**Версия скрипта:** v002
...
📁 FamilyFinanceProject/
    ...
    └── 📁 **src/** `/Users/user/github/FamilyFinanceProject/src`
        ...
        │       └─ `enable(self)` (строка 99)
        │       └─ `disable(self)` (строка 104)
        ...
        └── 📁 **agents/** `/Users/user/github/FamilyFinanceProject/src/agents`
            ...
            │       └─ `create_error_response(self, error_message)` (строка 90)
            │       └─ `create_success_response(self, message, data=None)` (строка 107)
            ...
            │       └─ `_validate_expense_data(self, expense_data)` (строка 100)
            │       └─ `_create_google_request(self, expense_data)` (строка 135)
            ...
            │       └─ `__init__(self)` (строка 17) [magic]
            │       └─ `_validate_income_data(self, income_data)` (строка 100)
            │       └─ `_create_google_request(self, income_data)` (строка 135)
            │       └─ `_format_success_message(self, income_data)` (строка 154)
